...
//               <div className='py-4'> 
//                 <Link to= "/"> 
//                     <h3 className="text-lg font-meduim hover:text-blue-500 mb-4">
//                     {item.title}
//                     </h3>
...
import news2 from "../../assets/news/news-2.png";
const news = [
  { id: 1, title: "Global Climate Summit Calls for Urgent Action", image: news1 },
  { id: 2, title: "Breakthrough in AI Technology Announced", image: news2 },
];
const News = () => {
  return (
